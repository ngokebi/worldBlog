...
?>
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Settings | Blogry - Admin Dashboard</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Register Author</h4>
                                        <p class="card-title-desc">Register your athors. They are responsible for <code>managing</code> Posts and Comments </p>
                                        <form method="POST">
                                            <div>
                                                <div class="mb-4">
                                                ...
                                                <div>
                                                    <button class="btn btn-outline-success" type="submit" id="author_submit">Submit</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <?php
                                                $role = 'author';
                                                $sql = "SELECT *,DATE_FORMAT(DateCreated, '%M %d, %Y') as DateCreated FROM users WHERE role = :role";
                                                ...
                                                ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="btn btn-outline-danger btn-sm delete_author" href="" author_id="<?php echo htmlentities($result->id); ?>" title="Delete">
